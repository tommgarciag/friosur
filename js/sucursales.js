...
let madryn = new Sucursal(
  ...
  "Javier",
  "https://goo.gl/maps/zcPhgkRV8UTR1RZE6"
);
let caleta = new Sucursal(
  ...
  "Facundo",
  "https://goo.gl/maps/mG7TtjRQSgJjDNHt9"
);
let comodoro = new Sucursal(
  ...
  "Marcelo",
  "https://goo.gl/maps/KbSGuAECQ7srXk95A"
);
let esquel = new Sucursal(
  ...
  "Elio",
  "https://goo.gl/maps/HLhy47xprjiVaGcg8"
);
let gallegos = new Sucursal(
  ...
  "José",
  "https://goo.gl/maps/FGt1RoRgNuEMv67GA"
);
let sao = new Sucursal(
  "../img/sucursal_sao.jpg",
  "San Antonio Oeste",
  "Hipólito Yrigoyen 425",
  " 02934422309",
  " 2934447904",
  "https://wa.me/542934447904",
  "Hernan",
  "https://goo.gl/maps/vLkdfbcvuQux7Xx17"
);
let trelew = new Sucursal(
  "../img/sucursal_trelew.jpg",
  "Trelew",
  "Lezana 944",
  " 02804424393",
  " 2804669826",
  ...
  "Marcos",
  "https://goo.gl/maps/nJiPzDfmCQb46U7r7"
);
